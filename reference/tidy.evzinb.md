...
#>  1 zero    (Intercept)    0.511    0.204      2.50      0.5
#>  2 zero    x1            -0.674    0.204     -3.31      0.5
#>  3 zero    x2             0.607    0.323      1.88      0.5
#>  4 zero    x3            -0.420    0.0187   -22.5       0.5
#>  5 evi     (Intercept)   -1.73     0.566     -3.06      0.5
#>  6 evi     x1             0.736    0.210      3.50      1  
#>  7 evi     x2            -0.429    0.792     -0.542     1  
#>  8 evi     x3             0.166    0.0134    12.4       0.5
#>  9 count   (Intercept)    3.13     0.269     11.6       0.5
#> 10 count   x1             0.843    0.152      5.54      0.5
#> 11 count   x2             0.599    0.172      3.47      0.5
#> 12 count   x3             0.241    0.528      0.457     1  
#> 13 pareto  (Intercept)    2.71     0.302      8.99      0.5
#> 14 pareto  x1            -2.28     1.51      -1.50      0.5
#> 15 pareto  x2             1.45     1.02       1.42      0.5
#> 16 pareto  x3             1.50     0.772      1.95      0.5
