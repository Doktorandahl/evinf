...
#>  1 evi     (Intercept)   -2.69      1.02     -2.65    0.333
#>  2 evi     x1             0.902     0.193     4.68    0.333
#>  3 evi     x2            -0.580     0.169    -3.43    0.333
#>  4 evi     x3             0.354     0.291     1.21    0.333
#>  5 count   (Intercept)    2.25      0.126    17.9     0.333
#>  6 count   x1             1.39      0.181     7.69    0.333
#>  7 count   x2             0.192     0.645     0.297   0.667
#>  8 count   x3             0.386     0.168     2.30    0.667
#>  9 pareto  (Intercept)    2.80      0.972     2.88    0.333
#> 10 pareto  x1            -2.45      0.726    -3.37    0.333
#> 11 pareto  x2             1.57      0.138    11.4     0.333
#> 12 pareto  x3             1.68      0.196     8.57    0.333
# }
```
