...
- type:
  ...
  `"harmonic"`, `"explog"`, `"states"` or `"quantile"`.
...
- clamp_alpha_pl:
  ...
  [`predict()`](https://rdrr.io/r/stats/predict.html) for both the point
  estimate and every bootstrap replicate. See
...
#> 1 x1       dydx     harmonic     140.      26.9     89.4      149.
# }
```
