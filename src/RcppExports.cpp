...
// ell_nb_i_fun
double ell_nb_i_fun(arma::vec beta_nb, double alpha_nb, arma::vec x_nb_ext_i, int y_i, double offset_nb_i);
RcppExport SEXP _evinf_ell_nb_i_fun(SEXP beta_nbSEXP, SEXP alpha_nbSEXP, SEXP x_nb_ext_iSEXP, SEXP y_iSEXP, SEXP offset_nb_iSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(ell_nb_i_fun(beta_nb, alpha_nb, x_nb_ext_i, y_i, offset_nb_i));
    return rcpp_result_gen;
END_RCPP
}
// ell_pois_i_fun
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type y_i(y_iSEXP);
    Rcpp::traits::input_parameter< double >::type offset_nb_i(offset_nb_iSEXP);
    rcpp_result_gen = Rcpp::wrap(delldtheta_nb_i_fun(beta_nb, alpha_nb, x_nb_ext_i, y_i, offset_nb_i));
    return rcpp_result_gen;
END_RCPP
}
// d2elldtheta2_nb_i_fun
arma::mat d2elldtheta2_nb_i_fun(arma::vec beta_nb, double alpha_nb, arma::vec x_nb_ext_i, int y_i, double offset_nb_i);
RcppExport SEXP _evinf_d2elldtheta2_nb_i_fun(SEXP beta_nbSEXP, SEXP alpha_nbSEXP, SEXP x_nb_ext_iSEXP, SEXP y_iSEXP, SEXP offset_nb_iSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type beta_nb(beta_nbSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type y_i(y_iSEXP);
    Rcpp::traits::input_parameter< double >::type offset_nb_i(offset_nb_iSEXP);
    rcpp_result_gen = Rcpp::wrap(d2elldtheta2_nb_i_fun(beta_nb, alpha_nb, x_nb_ext_i, y_i, offset_nb_i));
    return rcpp_result_gen;
END_RCPP
}
// ell_pl_i_fun
...
// delldbeta_pl_i_fun_exact
arma::vec delldbeta_pl_i_fun_exact(arma::vec beta_pl, double c_pl, arma::vec x_pl_ext_i, double y_i);
RcppExport SEXP _evinf_delldbeta_pl_i_fun_exact(SEXP beta_plSEXP, SEXP c_plSEXP, SEXP x_pl_ext_iSEXP, SEXP y_iSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type beta_pl(beta_plSEXP);
    ...
    Rcpp::traits::input_parameter< arma::vec >::type x_pl_ext_i(x_pl_ext_iSEXP);
    Rcpp::traits::input_parameter< double >::type y_i(y_iSEXP);
    rcpp_result_gen = Rcpp::wrap(delldbeta_pl_i_fun_exact(beta_pl, c_pl, x_pl_ext_i, y_i));
    return rcpp_result_gen;
END_RCPP
}
// d2elldbeta2_pl_i_fun_exact
arma::mat d2elldbeta2_pl_i_fun_exact(arma::vec beta_pl, double c_pl, arma::vec x_pl_ext_i, double y_i);
RcppExport SEXP _evinf_d2elldbeta2_pl_i_fun_exact(SEXP beta_plSEXP, SEXP c_plSEXP, SEXP x_pl_ext_iSEXP, SEXP y_iSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type beta_pl(beta_plSEXP);
    ...
    Rcpp::traits::input_parameter< arma::vec >::type x_pl_ext_i(x_pl_ext_iSEXP);
    Rcpp::traits::input_parameter< double >::type y_i(y_iSEXP);
    rcpp_result_gen = Rcpp::wrap(d2elldbeta2_pl_i_fun_exact(beta_pl, c_pl, x_pl_ext_i, y_i));
    return rcpp_result_gen;
END_RCPP
}
// log_lik_fun
double log_lik_fun(arma::vec gamma_z, arma::vec gamma_pl, arma::vec beta_nb, double alpha_nb, arma::vec beta_pl, double c_pl, arma::mat x_mult_z_ext, arma::mat x_mult_pl_ext, arma::mat x_nb_ext, arma::mat x_pl_ext, arma::vec y, arma::vec offset_nb, arma::vec offset_zc, arma::vec offset_pl_mult, arma::vec w, int family_count, int family_zero, bool has_weights);
RcppExport SEXP _evinf_log_lik_fun(SEXP gamma_zSEXP, SEXP gamma_plSEXP, SEXP beta_nbSEXP, SEXP alpha_nbSEXP, SEXP beta_plSEXP, SEXP c_plSEXP, SEXP x_mult_z_extSEXP, SEXP x_mult_pl_extSEXP, SEXP x_nb_extSEXP, SEXP x_pl_extSEXP, SEXP ySEXP, SEXP offset_nbSEXP, SEXP offset_zcSEXP, SEXP offset_pl_multSEXP, SEXP wSEXP, SEXP family_countSEXP, SEXP family_zeroSEXP, SEXP has_weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< arma::vec >::type offset_nb(offset_nbSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type family_zero(family_zeroSEXP);
    Rcpp::traits::input_parameter< bool >::type has_weights(has_weightsSEXP);
    rcpp_result_gen = Rcpp::wrap(log_lik_fun(gamma_z, gamma_pl, beta_nb, alpha_nb, beta_pl, c_pl, x_mult_z_ext, x_mult_pl_ext, x_nb_ext, x_pl_ext, y, offset_nb, offset_zc, offset_pl_mult, w, family_count, family_zero, has_weights));
    return rcpp_result_gen;
END_RCPP
}
// log_lik_profile_fun
arma::vec log_lik_profile_fun(arma::vec gamma_z, arma::vec gamma_pl, arma::vec beta_nb, double alpha_nb, arma::vec beta_pl, arma::vec c_candidates, arma::mat x_mult_z_ext, arma::mat x_mult_pl_ext, arma::mat x_nb_ext, arma::mat x_pl_ext, arma::vec y, arma::vec offset_nb, arma::vec offset_zc, arma::vec offset_pl_mult, arma::vec w, int family_count, int family_zero, bool has_weights);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type alpha_nb(alpha_nbSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type beta_pl(beta_plSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type c_candidates(c_candidatesSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type x_mult_z_ext(x_mult_z_extSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type x_mult_pl_ext(x_mult_pl_extSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type x_nb_ext(x_nb_extSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type x_pl_ext(x_pl_extSEXP);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type family_zero(family_zeroSEXP);
    Rcpp::traits::input_parameter< bool >::type has_weights(has_weightsSEXP);
    rcpp_result_gen = Rcpp::wrap(update_bfgs_fun(gamma_z_in, gamma_pl_in, beta_nb_in, alpha_nb_in, beta_pl_in, c_pl, x_mult_z_ext, x_mult_pl_ext, x_nb_ext, x_pl_ext, y, max_upd_par, no_m_bfgs_steps, offset_nb, offset_zc, offset_pl_mult, w, family_count, exact_pl, family_zero, has_weights));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_evinf_log_lik_fun", (DL_FUNC) &_evinf_log_lik_fun, 18},
    {"_evinf_log_lik_profile_fun", (DL_FUNC) &_evinf_log_lik_profile_fun, 18},
    {"_evinf_update_bfgs_fun", (DL_FUNC) &_evinf_update_bfgs_fun, 21},
    {NULL, NULL, 0}
};
