...
#'
#' @param x A fitted bootstrapped zero-inflated Poisson model
#' @param coef_type What type of coefficient should be reported, original, bootstrapped mean, or bootstrapped median
#' @param standard_error Should bootstrapped standard errors be reported?
#' @param p_value What type of p-value should be reported? Bootstrapped p_values, approximate p-values, or none?
#' @param confint What type of confidence intervals should be reported? Bootstrapped p_values, approximate p-values, or none?
...
#' @param component Which component should be shown?
#'
#' @return A tidy function for a bootstrapped ZIP model
#'
#' @export
#'
#' @examples
...
#' tidy(zip_comp$zip)
#' }
tidy.zipboot <- function(x, component = c('all','count','zero'),coef_type = c('original','bootstrap_mean','bootstrap_median'), standard_error=TRUE, p_value = c('bootstrapped','approx','none'), confint = c('none','bootstrapped','approx'),conf_level = 0.95,approx_t_value = TRUE,symmetric_bootstrap_p = TRUE,...){
  ...
  nobs <- x$full_run$n
  # round9 E.3: no dispersion parameter for a Poisson count part, unlike
  # zinbboot's +1 for theta.
...
#'
#' @param x A fitted bootstrapped Poisson model
#' @param coef_type What type of coefficient should be reported, original, bootstrapped mean, or bootstrapped median
#' @param standard_error Should bootstrapped standard errors be reported?
#' @param p_value What type of p-value should be reported? Bootstrapped p_values, approximate p-values, or none?
#' @param confint What type of confidence intervals should be reported? Bootstrapped p_values, approximate p-values, or none?
...
#' @param include_ylev Logical. Should y.lev be included in the tidy output? Makes for nicer tables when using modelsummary
#'
#' @return A tidy function for a bootstrapped Poisson model
#'
#' @export
#'
#' @examples
...
#' }
tidy.poissonboot <- function(x, coef_type = c('original','bootstrap_mean','bootstrap_median'), standard_error=TRUE, p_value = c('bootstrapped','approx','none'), confint = c('none','bootstrapped','approx'),conf_level = 0.95,approx_t_value = TRUE,symmetric_bootstrap_p = TRUE,include_ylev = FALSE,...){
